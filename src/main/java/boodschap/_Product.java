...
public abstract class _Product implements Serializable, Cloneable, SqlRecord
{
  ...
  static
  {
    ...
    SQL_TABLE_DEF.setQuery("SELECT Product.Id, Product.Soort, Product.Product, Product.Aantal, Product.Gekocht FROM Product");
    SQL_TABLE_DEF.setType(1);
    SqlColumnList cols = new SqlColumnList(5);
    SqlColumn col = null;
    col = new SqlColumn(1,4,"Product.Id","java.lang.Integer",false,true,true,true,true);
    cols.addObject( col);
    col = new SqlColumn(2,12,"Product.Soort","java.lang.String",false,true,false,true,false);
    cols.addObject( col);
    col = new SqlColumn(3,12,"Product.Product","java.lang.String",false,true,false,true,false);
    cols.addObject( col);
    col = new SqlColumn(4,12,"Product.Aantal","java.lang.String",false,false,false,false,false);
    cols.addObject( col);
    col = new SqlColumn(5,-7,"Product.Gekocht","java.lang.Boolean",false,false,false,false,false);
    cols.addObject( col);
    ...
    throws Exception
  {
    try
    {
      ...
      soort = (java.lang.String)data[1];
      product = (java.lang.String)data[2];
      aantal = (java.lang.String)data[3];
      gekocht = (java.lang.Boolean)data[4];
    }
